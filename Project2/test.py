...
nums = [50, 100, 500, 1000, 5000, 10000]
l_rate = [0, 0.03, 0.07, 0.1]
c_rate = [0, 0.03, 0.07, 0.1]
max_del = [0, 0.03, 0.07, 0.1]
        ...
        for c in c_rate:
            for m in max_del:
                ...
                def main():
                    ...
                    lossy_socket.sim = lossy_socket.SimulationParams(loss_rate=l, corruption_rate=c,
                                                                     max_delivery_delay=m,
                    ...
                    print("Parameters: loss_rate={}, corruption_rate={}, and max_delivery_delay={}.".format(l,c,m))
